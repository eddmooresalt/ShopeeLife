      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="flex flex-col items-center space-y-4">
            <div className="relative w-32 h-32 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-6xl border-4 border-orange-500">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                  Burnout reduces your effectiveness. Lower is better. Manage it with breaks and wellness activities.
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ScrollArea className="h-[100px] border rounded-md p-2">
              {wardrobe.length === 0 ? (
                <p className="text-center text-gray-500 dark:text-gray-400">Your wardrobe is empty. Visit the shop!</p>
              ) : (
